  ...
  return (
    <footer className="bg-white border-t border-gray-200 text-black font-manrope text-sm">
      ...
      <div className="w-full flex justify-center">
        <div className="max-w-[1200px] w-full px-45 py-20">
          {/* Logo */}
          <div className="mb-12">
            <img
          ...
          {/* Footer Links */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-[80px] gap-y-12">
          ...
          {/* Footer Bottom Text */}
          <div className="border-t border-gray-200 mt-12 pt-4 text-xs text-gray-600 flex flex-col md:flex-row justify-between items-center">
